...
See `report-template.md`. Community default order:
...
5. Distance ops  
6. MBTI (fun)  
7. CIA/KGB-style persona card  
8. Cross-check prompts  

Optional HTML graphs — public shape reference:  
`docs/sample-community-report.html` (**synthetic only**; never paste real dossiers).
